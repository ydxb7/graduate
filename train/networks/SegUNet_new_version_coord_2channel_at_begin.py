...
class SegUNet_new_version_coord_2channel_at_begin(nn.Module):
    def __init__(self,num_channels=5, num_classes=2):
        super(SegUNet_new_version_coord_2channel_at_begin, self).__init__()
        ...
        if num_channels != 3:
            encoders[0] = nn.Conv2d(num_channels, 64, 3, padding=1)
        ...
        self.dec5 = ConvBlock(512, 512, 1)          # 32*32*512 --> 32*32*512
...
#         print(x.size(), coord.size())
        enc1 = self.enc1(torch.cat([x, coord], 1))
